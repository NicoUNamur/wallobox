...
$pdf->SetFont('Arial','',10);
	...
	$pdf->Cell(90,9,"<Nom de la commune>",0,0,'L');
	$pdf->Cell(90,9,"<Nom et prénom de l’agent>",0,1,'R');
	$pdf->Cell(90,9,"",0,0,'L');
	$pdf->Cell(90,9,"<Nom du service>",0,1,'R');

	$pdf->Cell(90,9,"<Adresse de la commune>",0,0,'L');
	$pdf->Cell(90,9,"<Adresse du service>",0,1,'R');

	$pdf->Cell(90,9,"<Numéro de téléphone>",0,0,'L');
	$pdf->Cell(90,9,"<Numéro de téléphone de l’agent ou du service>",0,1,'R');

	$pdf->Cell(90,9,"<Adresse e-mail>",0,0,'L');
	$pdf->Cell(90,9,"<Adresse e-mail de l’agent ou du service>",0,1,'R');
	$pdf->Ln();
	$pdf->Cell(60,9,"Votre référence :",0,0,'L');
	$pdf->Cell(60,9,"Notre référence :",0,0,'L');
	$pdf->Cell(60,9,"Référence <nom du système> :",0,1,'L');
				
	$pdf->Cell(60,9,"<référence citoyen>",0,0,'L');
	$pdf->Cell(60,9,"<référence communale>",0,0,'L');
	$pdf->Cell(60,9,"<référence système>",0,1,'L');
	$pdf->Ln();
